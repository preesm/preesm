...
public class ListSchedulingClassicWithStaticOrderByBottomLevelInOut extends
		ListSchedulingClassic {

	public ListSchedulingClassicWithStaticOrderByBottomLevelInOut(
			AlgorithmDescriptor algorithm, ArchitectureDescriptor architecture) {
		super(algorithm, architecture);
		// TODO Auto-generated constructor stub
		this.name = "List Scheduling Classic With Static Order By Bottom Level InOut";
	}
