...
public class ListSchedulingCriticalChildClassicWithStaticOrderByBottomLevel
		extends ListSchedulingCriticalChildClassic {

	public ListSchedulingCriticalChildClassicWithStaticOrderByBottomLevel(
			AlgorithmDescriptor algorithm, ArchitectureDescriptor architecture) {
		super(algorithm, architecture);
		// TODO Auto-generated constructor stub
		this.name = "List Scheduling CriticalChildClassic With Static Order By Bottom Level";
	}
