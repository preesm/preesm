...
public class ListSchedulingBasicWithStaticOrderByBottomLevelOut extends
		ListSchedulingBasic {

	public ListSchedulingBasicWithStaticOrderByBottomLevelOut(
			AlgorithmDescriptor algorithm, ArchitectureDescriptor architecture) {
		super(algorithm, architecture);
		// TODO Auto-generated constructor stub
		this.name = "List Scheduling Basic With Static Order By Bottom Level Out";
	}
