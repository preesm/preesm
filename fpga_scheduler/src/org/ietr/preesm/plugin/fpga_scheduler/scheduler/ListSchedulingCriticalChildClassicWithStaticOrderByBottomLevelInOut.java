...
public class ListSchedulingCriticalChildClassicWithStaticOrderByBottomLevelInOut
		extends ListSchedulingCriticalChildClassic {

	public ListSchedulingCriticalChildClassicWithStaticOrderByBottomLevelInOut(
			AlgorithmDescriptor algorithm, ArchitectureDescriptor architecture) {
		super(algorithm, architecture);
		// TODO Auto-generated constructor stub
		this.name = "List Scheduling CriticalChildClassic With Static Order By Bottom Level InOut";
	}
