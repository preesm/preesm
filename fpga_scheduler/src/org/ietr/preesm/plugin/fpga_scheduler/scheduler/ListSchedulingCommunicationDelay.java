...
public class ListSchedulingCommunicationDelay extends ListSchedulingClassic {

	public ListSchedulingCommunicationDelay(AlgorithmDescriptor algorithm,
			ArchitectureDescriptor architecture) {
		super(algorithm, architecture);
		// TODO Auto-generated constructor stub
		this.name = "List Scheduling Communication Delay";
	}
