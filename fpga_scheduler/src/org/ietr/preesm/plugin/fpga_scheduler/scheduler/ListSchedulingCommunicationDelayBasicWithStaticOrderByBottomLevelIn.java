...
public class ListSchedulingCommunicationDelayBasicWithStaticOrderByBottomLevelIn
		extends ListSchedulingCommunicationDelayBasic {

	public ListSchedulingCommunicationDelayBasicWithStaticOrderByBottomLevelIn(
			AlgorithmDescriptor algorithm, ArchitectureDescriptor architecture) {
		super(algorithm, architecture);
		// TODO Auto-generated constructor stub
		this.name = "List Scheduling CommunicationDelayBasic With Static Order By Bottom Level In";
	}
