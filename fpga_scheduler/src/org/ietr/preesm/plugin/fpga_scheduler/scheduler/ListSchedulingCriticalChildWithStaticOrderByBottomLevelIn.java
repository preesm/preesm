...
public class ListSchedulingCriticalChildWithStaticOrderByBottomLevelIn extends
		ListSchedulingCriticalChild {

	public ListSchedulingCriticalChildWithStaticOrderByBottomLevelIn(
			AlgorithmDescriptor algorithm, ArchitectureDescriptor architecture) {
		super(algorithm, architecture);
		// TODO Auto-generated constructor stub
		this.name = "List Scheduling CriticalChild With Static Order By Bottom Level In";
	}
