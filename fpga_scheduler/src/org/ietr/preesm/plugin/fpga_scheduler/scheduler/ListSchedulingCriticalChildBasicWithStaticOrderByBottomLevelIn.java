...
public class ListSchedulingCriticalChildBasicWithStaticOrderByBottomLevelIn
		extends ListSchedulingCriticalChildBasic {

	public ListSchedulingCriticalChildBasicWithStaticOrderByBottomLevelIn(
			AlgorithmDescriptor algorithm, ArchitectureDescriptor architecture) {
		super(algorithm, architecture);
		// TODO Auto-generated constructor stub
		this.name = "List Scheduling CriticalChildBasic With Static Order By Bottom Level In";
	}
