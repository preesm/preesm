...
public class ListSchedulingCcCdBasicWithStaticOrderByBottomLevelIn extends
		ListSchedulingCcCdBasic {

	public ListSchedulingCcCdBasicWithStaticOrderByBottomLevelIn(
			AlgorithmDescriptor algorithm, ArchitectureDescriptor architecture) {
		super(algorithm, architecture);
		// TODO Auto-generated constructor stub
		this.name = "List Scheduling CcCdBasic With Static Order By Bottom Level In";
	}
