...
public class ListSchedulingAdvancedWithStaticOrderByBottomLevelInOut extends
		ListSchedulingAdvanced {

	public ListSchedulingAdvancedWithStaticOrderByBottomLevelInOut(
			AlgorithmDescriptor algorithm, ArchitectureDescriptor architecture) {
		super(algorithm, architecture);
		// TODO Auto-generated constructor stub
		this.name = "List Scheduling Advanced With Static Order By Bottom Level InOut";
	}
