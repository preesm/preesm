...
public class ListSchedulingCommunicationDelayBasicWithStaticOrderByBottomLevelOut
		extends ListSchedulingCommunicationDelayBasic {

	public ListSchedulingCommunicationDelayBasicWithStaticOrderByBottomLevelOut(
			AlgorithmDescriptor algorithm, ArchitectureDescriptor architecture) {
		super(algorithm, architecture);
		// TODO Auto-generated constructor stub
		this.name = "List Scheduling CommunicationDelayBasic With Static Order By Bottom Level Out";
	}
