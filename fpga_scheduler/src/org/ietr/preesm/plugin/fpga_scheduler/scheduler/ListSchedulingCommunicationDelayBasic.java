...
public class ListSchedulingCommunicationDelayBasic extends
		ListSchedulingClassic {

	public ListSchedulingCommunicationDelayBasic(AlgorithmDescriptor algorithm,
			ArchitectureDescriptor architecture) {
		super(algorithm, architecture);
		// TODO Auto-generated constructor stub
		this.name = "List Scheduling CommunicationDelayBasic";
	}
