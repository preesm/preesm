...
public class ListSchedulingClassic extends AbstractScheduler {

	public ListSchedulingClassic(AlgorithmDescriptor algorithm,
			ArchitectureDescriptor architecture) {
		super(algorithm);
		// TODO Auto-generated constructor stub
		this.architecture = architecture;
		this.name = "List Scheduling Classic";
	}
