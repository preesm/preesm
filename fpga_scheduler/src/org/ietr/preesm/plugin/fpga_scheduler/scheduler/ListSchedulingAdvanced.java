...
public class ListSchedulingAdvanced extends AbstractScheduler {

	public ListSchedulingAdvanced(AlgorithmDescriptor algorithm,
			ArchitectureDescriptor architecture) {
		super(algorithm);
		this.architecture = architecture;
		this.name = "List Scheduling Advanced";
	}
