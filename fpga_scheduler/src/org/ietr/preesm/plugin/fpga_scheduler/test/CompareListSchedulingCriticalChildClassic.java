...
public class CompareListSchedulingCriticalChildClassic extends
		CompareListScheduling {

	public CompareListSchedulingCriticalChildClassic(String algorithmFileName,
			String parameterFileName, String architectureFileName) {
		super(algorithmFileName, parameterFileName, architectureFileName);
		System.out
				.println("\n***** Compare List Scheduling Critical Child Classic Begins! *****");
		parse(algorithmFileName, architectureFileName, parameterFileName);
		ListSchedulingCriticalChildClassicWithStaticOrderByBottomLevelComputation scheduler1 = new ListSchedulingCriticalChildClassicWithStaticOrderByBottomLevelComputation(
				algorithm, architecture);
		testScheduler(scheduler1, algorithm, architecture);

		parse(algorithmFileName, architectureFileName, parameterFileName);
		ListSchedulingCriticalChildClassicWithStaticOrderByBottomLevel scheduler2 = new ListSchedulingCriticalChildClassicWithStaticOrderByBottomLevel(
				algorithm, architecture);
		testScheduler(scheduler2, algorithm, architecture);

		parse(algorithmFileName, architectureFileName, parameterFileName);
		ListSchedulingCriticalChildClassicWithStaticOrderByBottomLevelIn scheduler3 = new ListSchedulingCriticalChildClassicWithStaticOrderByBottomLevelIn(
				algorithm, architecture);
		testScheduler(scheduler3, algorithm, architecture);

		parse(algorithmFileName, architectureFileName, parameterFileName);
		ListSchedulingCriticalChildClassicWithStaticOrderByBottomLevelOut scheduler4 = new ListSchedulingCriticalChildClassicWithStaticOrderByBottomLevelOut(
				algorithm, architecture);
		testScheduler(scheduler4, algorithm, architecture);

		parse(algorithmFileName, architectureFileName, parameterFileName);
		ListSchedulingCriticalChildClassicWithStaticOrderByBottomLevelInOut scheduler5 = new ListSchedulingCriticalChildClassicWithStaticOrderByBottomLevelInOut(
				algorithm, architecture);
		...
		System.out
				.println("\n\n*****Compare List Scheduling Critical Child Classic Finishes!*****");
	}
	...
	public static void main(String[] args) {
		...
		new CompareListSchedulingCriticalChildClassic(algorithmFileName,
