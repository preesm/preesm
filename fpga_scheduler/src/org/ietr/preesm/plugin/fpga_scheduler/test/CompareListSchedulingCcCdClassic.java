...
public class CompareListSchedulingCcCdClassic extends CompareListScheduling {

	public CompareListSchedulingCcCdClassic(String algorithmFileName,
			String parameterFileName, String architectureFileName) {
		super(algorithmFileName, parameterFileName, architectureFileName);
		System.out
				.println("\n***** Compare List Scheduling CcCdClassic Begins! *****");
		parse(algorithmFileName, architectureFileName, parameterFileName);
		ListSchedulingCcCdClassicWithStaticOrderByBottomLevelComputation scheduler1 = new ListSchedulingCcCdClassicWithStaticOrderByBottomLevelComputation(
				algorithm, architecture);
		testScheduler(scheduler1, algorithm, architecture);

		parse(algorithmFileName, architectureFileName, parameterFileName);
		ListSchedulingCcCdClassicWithStaticOrderByBottomLevel scheduler2 = new ListSchedulingCcCdClassicWithStaticOrderByBottomLevel(
				algorithm, architecture);
		testScheduler(scheduler2, algorithm, architecture);

		parse(algorithmFileName, architectureFileName, parameterFileName);
		ListSchedulingCcCdClassicWithStaticOrderByBottomLevelIn scheduler3 = new ListSchedulingCcCdClassicWithStaticOrderByBottomLevelIn(
				algorithm, architecture);
		testScheduler(scheduler3, algorithm, architecture);

		parse(algorithmFileName, architectureFileName, parameterFileName);
		ListSchedulingCcCdClassicWithStaticOrderByBottomLevelOut scheduler4 = new ListSchedulingCcCdClassicWithStaticOrderByBottomLevelOut(
				algorithm, architecture);
		testScheduler(scheduler4, algorithm, architecture);

		parse(algorithmFileName, architectureFileName, parameterFileName);
		ListSchedulingCcCdClassicWithStaticOrderByBottomLevelInOut scheduler5 = new ListSchedulingCcCdClassicWithStaticOrderByBottomLevelInOut(
				algorithm, architecture);
		...
		System.out
				.println("\n\n*****Compare List Scheduling CcCdClassic Finishes!*****");
	}
	...
	public static void main(String[] args) {
		...
		new CompareListSchedulingCcCdClassic(algorithmFileName, parameterFileName,
