...
public class CompareListSchedulingCommunicationDelay extends
		CompareListScheduling {

	public CompareListSchedulingCommunicationDelay(String algorithmFileName,
			String parameterFileName, String architectureFileName) {
		super(algorithmFileName, parameterFileName, architectureFileName);
		System.out
				.println("\n***** Compare List Scheduling Communication Delay Begins! *****");
		parse(algorithmFileName, architectureFileName, parameterFileName);
		ListSchedulingCommunicationDelayWithStaticOrderByBottomLevelComputation scheduler1 = new ListSchedulingCommunicationDelayWithStaticOrderByBottomLevelComputation(
				algorithm, architecture);
		testScheduler(scheduler1, algorithm, architecture);

		parse(algorithmFileName, architectureFileName, parameterFileName);
		ListSchedulingCommunicationDelayWithStaticOrderByBottomLevel scheduler2 = new ListSchedulingCommunicationDelayWithStaticOrderByBottomLevel(
				algorithm, architecture);
		testScheduler(scheduler2, algorithm, architecture);

		parse(algorithmFileName, architectureFileName, parameterFileName);
		ListSchedulingCommunicationDelayWithStaticOrderByBottomLevelIn scheduler3 = new ListSchedulingCommunicationDelayWithStaticOrderByBottomLevelIn(
				algorithm, architecture);
		testScheduler(scheduler3, algorithm, architecture);

		parse(algorithmFileName, architectureFileName, parameterFileName);
		ListSchedulingCommunicationDelayWithStaticOrderByBottomLevelOut scheduler4 = new ListSchedulingCommunicationDelayWithStaticOrderByBottomLevelOut(
				algorithm, architecture);
		testScheduler(scheduler4, algorithm, architecture);

		parse(algorithmFileName, architectureFileName, parameterFileName);
		ListSchedulingCommunicationDelayWithStaticOrderByBottomLevelInOut scheduler5 = new ListSchedulingCommunicationDelayWithStaticOrderByBottomLevelInOut(
				algorithm, architecture);
		...
		System.out
				.println("\n\n*****Compare List Scheduling Communication Delay Finishes!*****");
	}
	...
	public static void main(String[] args) {
		...
		new CompareListSchedulingCommunicationDelay(algorithmFileName,
