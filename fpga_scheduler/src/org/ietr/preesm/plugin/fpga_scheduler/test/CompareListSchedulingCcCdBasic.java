...
public class CompareListSchedulingCcCdBasic extends CompareListScheduling {

	public CompareListSchedulingCcCdBasic(String algorithmFileName,
			String parameterFileName, String architectureFileName) {
		super(algorithmFileName, parameterFileName, architectureFileName);
		System.out
				.println("\n***** Compare List Scheduling CcCdBasic Begins! *****");
		parse(algorithmFileName, architectureFileName, parameterFileName);
		ListSchedulingCcCdBasicWithStaticOrderByBottomLevelComputation scheduler1 = new ListSchedulingCcCdBasicWithStaticOrderByBottomLevelComputation(
				algorithm, architecture);
		testScheduler(scheduler1, algorithm, architecture);

		parse(algorithmFileName, architectureFileName, parameterFileName);
		ListSchedulingCcCdBasicWithStaticOrderByBottomLevel scheduler2 = new ListSchedulingCcCdBasicWithStaticOrderByBottomLevel(
				algorithm, architecture);
		testScheduler(scheduler2, algorithm, architecture);

		parse(algorithmFileName, architectureFileName, parameterFileName);
		ListSchedulingCcCdBasicWithStaticOrderByBottomLevelIn scheduler3 = new ListSchedulingCcCdBasicWithStaticOrderByBottomLevelIn(
				algorithm, architecture);
		testScheduler(scheduler3, algorithm, architecture);

		parse(algorithmFileName, architectureFileName, parameterFileName);
		ListSchedulingCcCdBasicWithStaticOrderByBottomLevelOut scheduler4 = new ListSchedulingCcCdBasicWithStaticOrderByBottomLevelOut(
				algorithm, architecture);
		testScheduler(scheduler4, algorithm, architecture);

		parse(algorithmFileName, architectureFileName, parameterFileName);
		ListSchedulingCcCdBasicWithStaticOrderByBottomLevelInOut scheduler5 = new ListSchedulingCcCdBasicWithStaticOrderByBottomLevelInOut(
				algorithm, architecture);
		...
		System.out
				.println("\n\n*****Compare List Scheduling CcCdBasic Finishes!*****");
	}
	...
	public static void main(String[] args) {
		...
		new CompareListSchedulingCcCdBasic(algorithmFileName, parameterFileName,
