 ...
 *
 */
@PreesmTask(id = "org.ietr.preesm.pisdf.delayreplacement", name = "PiSDF Delay Replacement",
    inputs = { @Port(name = "PiMM", type = PiGraph.class) }, outputs = { @Port(name = "PiMM", type = PiGraph.class) })
public class PiSDFDelayReplacementTask extends AbstractTaskImplementation {
  ...
  public Map<String, Object> execute(Map<String, Object> inputs, Map<String, String> parameters,
    ...
    // Process graph
    PiSDFDelayReplacement process = new PiSDFDelayReplacement(algorithm);
    PiGraph processedAlgorithm = process.replaceDelay();
