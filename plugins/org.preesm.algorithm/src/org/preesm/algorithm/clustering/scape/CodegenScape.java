...
public class CodegenScape {
  ...
  private StringBuilder buildCContent(ScapeBuilder build, PiGraph subGraph) {
    ...
    result.append(header(subGraph));
    result.append(
        "#include \"Cluster_" + subGraph.getContainingPiGraph().getName() + "_" + subGraph.getName() + ".h\"\n\n");
  ...
  private StringBuilder header(PiGraph subGraph) {
    ...
    result.append("/**\n");
    result
        .append("* @file /Cluster_" + subGraph.getContainingPiGraph().getName() + "_" + subGraph.getName() + ".c/h\n");
