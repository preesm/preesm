...
public abstract class AbstractGenericFpgaFifoEvaluator {
  ...
  public static AbstractGenericFpgaFifoEvaluator getEvaluatorInstance(final String fifoEvaluatorName) {
    ...
    } else if (AdfgOjalgoFpgaFifoEvaluator.FIFO_EVALUATOR_ADFG_OJALGO_LINEAR.equalsIgnoreCase(fifoEvaluatorName)) {
      return new AdfgOjalgoFpgaFifoEvaluator(false);
    } else if (AdfgGlpkFpgaFifoEvaluator.FIFO_EVALUATOR_ADFG_GLPK_EXACT.equalsIgnoreCase(fifoEvaluatorName)) {
      return new AdfgOjalgoFpgaFifoEvaluator(true);
    } else if (AdfgGlpkFpgaFifoEvaluator.FIFO_EVALUATOR_ADFG_GLPK_LINEAR.equalsIgnoreCase(fifoEvaluatorName)) {
      return new AdfgOjalgoFpgaFifoEvaluator(false);
    }
