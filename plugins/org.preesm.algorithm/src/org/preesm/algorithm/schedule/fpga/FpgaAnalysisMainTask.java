    ...
    parameters = {
        ...
        @Parameter(name = FpgaAnalysisMainTask.FIFO_EVAL_PARAM_NAME,
            ...
            values = { @Value(name = AsapFpgaFifoEvaluator.FIFO_EVALUATOR_AVG, effect = "Evaluate with average mode."),
                ...
                @Value(name = AdfgOjalgoFpgaFifoEvaluator.FIFO_EVALUATOR_ADFG_OJALGO_EXACT,
                    effect = "Evaluate with ADFG exact mode using ojAlgo."),
                @Value(name = AdfgOjalgoFpgaFifoEvaluator.FIFO_EVALUATOR_ADFG_OJALGO_LINEAR,
                    effect = "Evaluate with ADFG linear approximation mode using ojAlgo."),
                @Value(name = AdfgGlpkFpgaFifoEvaluator.FIFO_EVALUATOR_ADFG_GLPK_EXACT,
                    effect = "Evaluate with ADFG exact mode using GLPK."),
                @Value(name = AdfgGlpkFpgaFifoEvaluator.FIFO_EVALUATOR_ADFG_GLPK_LINEAR,
                    effect = "Evaluate with ADFG linear approximation mode using GLPK.") }),
