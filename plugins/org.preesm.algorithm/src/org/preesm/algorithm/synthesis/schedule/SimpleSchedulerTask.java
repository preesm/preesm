...
@PreesmTask(id = "mapper2.simple", name = "Periodic Scheduling from PiSDF", category = "Schedulers",
...
public class SimpleSchedulerTask extends AbstractTaskImplementation {
  ...
  public Map<String, Object> execute(Map<String, Object> inputs, Map<String, String> parameters,
    ...
    final SynthesisResult result = new SimpleScheduler().scheduleAndMap(graph, arch, scenario, parameters);
