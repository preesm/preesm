...
@PreesmTask(id = "mapper2.periodic", name = "Periodic Scheduling from PiSDF", category = "Schedulers",
...
public class PeriodicSchedulerTask extends AbstractTaskImplementation {
  ...
  public Map<String, Object> execute(Map<String, Object> inputs, Map<String, String> parameters,
    ...
    final SynthesisResult result = new PeriodicScheduler().scheduleAndMap(graph, arch, scenario, parameters);
