...
/**
 * MemoryExclusionGraphNode is used to represent vertices in the Exclusion graph.
 * 
 * @author kdesnos
 *
 */
public class MemoryExclusionGraphNode {
	 ...
	 */
	public MemoryExclusionGraphNode(String sourceTask, String sinkTask, int sizeMem)
	{
		source = sourceTask;
		sink = sinkTask;
		size = sizeMem;		
	...
	/**
	 * Method added to enable the use of contains() method in Set<MemoryExclusionGraphNode>
	 */
	public int hashCode()
	{
	...
	public boolean equals(Object o){
		...
		if(o instanceof MemoryExclusionGraphNode)
			return (this.source.equals(((MemoryExclusionGraphNode)o).source) 
					&& this.sink.equals(((MemoryExclusionGraphNode)o).sink));
		else
			return false;
