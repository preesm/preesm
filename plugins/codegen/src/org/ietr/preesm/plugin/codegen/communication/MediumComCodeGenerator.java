...
/**
 * Generating communication code (initialization and calls) for a medium Route Step
 * 
 * @author mpelcat
 */
public class MediumComCodeGenerator extends AbstractComCodeGenerator {

	public MediumComCodeGenerator(CommunicationThreadDeclaration comThread) {
		super(comThread);
	}
