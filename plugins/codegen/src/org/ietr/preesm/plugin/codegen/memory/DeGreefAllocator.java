...
public class DeGreefAllocator extends MemoryAllocator {
	...
	public void allocate() {
		...
		while (!nonAllocatedVertices.isEmpty()) {
			...
			MemoryExclusionGraphNode vertex = currentPair.getSecond();

			@SuppressWarnings("unchecked")
			HashSet<MemoryExclusionGraphNode> neighbors = (HashSet<MemoryExclusionGraphNode>) inputExclusionGraph
	...
	protected class IntegerAndVertex implements Comparable<IntegerAndVertex> {
		...
		private MemoryExclusionGraphNode second;

		public IntegerAndVertex(Integer first, MemoryExclusionGraphNode second) {
			super();
			this.first = first;
			this.second = second;
		}
		...
		public MemoryExclusionGraphNode getSecond() {
			return second;
		}

		public void setSecond(MemoryExclusionGraphNode second) {
			this.second = second;
		}
