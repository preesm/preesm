 ...
 * For more details, see conference paper: "SimSDP: Dataflow Application Distribution on Heterogeneous Multi-Node Multi-Core Architectures, published at xx 2024
 * @author orenaud
 *
 */
...
public static final String VALUE_PRINTER_IR = "IR";
	...
	public Map<String, Object> execute(Map<String, Object> inputs, Map<String, String> parameters,
		...
		String archipath = parameters.get(NodePartitionerTask.ARCHI_PATH_PARAM);
		String workloadpath = parameters.get(NodePartitionerTask.WORKLOAD_PATH_PARAM);
		String printer = parameters.get(NodePartitionerTask.PARAM_PRINTER);
