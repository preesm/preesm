 ...
 * with Critical Child, Communication Delay and nodes sorted by bottom level.
 * 
 * @author pmu
 */
public class CListSchedCcCdBl extends CListSchedCcCd {

	public CListSchedCcCdBl(AlgorithmDescriptor algorithm,
			ArchitectureDescriptor architecture) {
		super(algorithm, architecture);
		// TODO Auto-generated constructor stub
		this.name = "Classic List Scheduling With Critical Child, Communication Delay And Nodes Sorted By Bottom Level";
	}
