...
public class CombCListSched {
	...
	public boolean schedule() {
		...
		ArchitectureDescriptor architecture1 = (ArchitectureDescriptor) architecture
				.clone();
		CListSchedBlcomp scheduler1 = new CListSchedBlcomp(algorithm1,
				architecture1);
		scheduler1.schedule();
		...
		ArchitectureDescriptor architecture2 = (ArchitectureDescriptor) architecture
				.clone();
		CListSchedBl scheduler2 = new CListSchedBl(algorithm2, architecture2);
		scheduler2.schedule();
		...
		ArchitectureDescriptor architecture3 = (ArchitectureDescriptor) architecture
				.clone();
		CListSchedBlin scheduler3 = new CListSchedBlin(algorithm3,
				architecture3);
		scheduler3.schedule();
		...
		ArchitectureDescriptor architecture4 = (ArchitectureDescriptor) architecture
				.clone();
		CListSchedBlout scheduler4 = new CListSchedBlout(algorithm4,
				architecture4);
		scheduler4.schedule();
		...
		ArchitectureDescriptor architecture5 = (ArchitectureDescriptor) architecture
				.clone();
		CListSchedBlinout scheduler5 = new CListSchedBlinout(algorithm5,
				architecture5);
		scheduler5.schedule();
