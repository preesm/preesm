...
public class ListSchedulingCriticalChildClassicWithStaticOrderByBottomLevelIn
		extends ListSchedulingCriticalChildClassic {

	public ListSchedulingCriticalChildClassicWithStaticOrderByBottomLevelIn(
			AlgorithmDescriptor algorithm, ArchitectureDescriptor architecture) {
		super(algorithm, architecture);
		// TODO Auto-generated constructor stub
		this.name = "List Scheduling CriticalChildClassic With Static Order By Bottom Level In";
	}
