...
public class ListSchedulingCommunicationDelayClassicWithStaticOrderByBottomLevelIn
		extends ListSchedulingCommunicationDelayClassic {

	public ListSchedulingCommunicationDelayClassicWithStaticOrderByBottomLevelIn(
			AlgorithmDescriptor algorithm, ArchitectureDescriptor architecture) {
		super(algorithm, architecture);
		// TODO Auto-generated constructor stub
		this.name = "List Scheduling CommunicationDelayClassic With Static Order By Bottom Level In";
	}
