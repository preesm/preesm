...
public class ListSchedulingCcCdClassic extends AbstractScheduler {

	public ListSchedulingCcCdClassic(AlgorithmDescriptor algorithm,
			ArchitectureDescriptor architecture) {
		super(algorithm);
		this.architecture = architecture;
		this.name = "List Scheduling CcCdClassic";
	}
