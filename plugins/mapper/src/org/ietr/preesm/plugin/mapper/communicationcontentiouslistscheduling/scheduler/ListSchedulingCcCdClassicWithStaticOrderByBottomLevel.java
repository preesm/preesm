...
public class ListSchedulingCcCdClassicWithStaticOrderByBottomLevel extends
		ListSchedulingCcCdClassic {

	public ListSchedulingCcCdClassicWithStaticOrderByBottomLevel(
			AlgorithmDescriptor algorithm, ArchitectureDescriptor architecture) {
		super(algorithm, architecture);
		// TODO Auto-generated constructor stub
		this.name = "List Scheduling CcCdClassic With Static Order By Bottom Level";
	}
