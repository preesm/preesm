...
public class ListSchedulingCcCdClassicWithStaticOrderByBottomLevelInOut extends
		ListSchedulingCcCdClassic {

	public ListSchedulingCcCdClassicWithStaticOrderByBottomLevelInOut(
			AlgorithmDescriptor algorithm, ArchitectureDescriptor architecture) {
		super(algorithm, architecture);
		// TODO Auto-generated constructor stub
		this.name = "List Scheduling CcCdClassic With Static Order By Bottom Level InOut";
	}
