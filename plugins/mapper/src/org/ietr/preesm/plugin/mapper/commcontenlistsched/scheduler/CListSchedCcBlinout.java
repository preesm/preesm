 ...
 * with Critical Child and nodes sorted by input/output bottom level.
 * 
 * @author pmu
 */
public class CListSchedCcBlinout extends CListSchedCc {

	public CListSchedCcBlinout(AlgorithmDescriptor algorithm,
			ArchitectureDescriptor architecture) {
		super(algorithm, architecture);
		// TODO Auto-generated constructor stub
		this.name = "Classic List Scheduling With Critical Child And Nodes Sorted By Input/Output Bottom Level";
	}
