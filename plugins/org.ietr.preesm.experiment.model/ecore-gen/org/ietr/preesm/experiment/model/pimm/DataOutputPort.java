...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Data Output Port</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
...
public interface DataOutputPort extends DataPort {
  ...
  /**
   * Sets the value of the '{@link org.ietr.preesm.experiment.model.pimm.DataOutputPort#getOutgoingFifo <em>Outgoing Fifo</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   *        annotation="http://www.eclipse.org/emf/2002/GenModel body='return &lt;%org.ietr.preesm.experiment.model.pimm.PortKind%&gt;.DATA_OUTPUT;'"
   * @generated
   */
  PortKind getKind();
   ...
   * <!-- end-user-doc -->
   * @model kind="operation" unique="false"
   *        annotation="http://www.eclipse.org/emf/2002/GenModel body='return this.getOutgoingFifo();'"
   * @generated
   */
  Fifo getFifo();
