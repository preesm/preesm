 ...
 * @generated
 */
public class FunctionPrototypeImpl extends MinimalEObjectImpl.Container implements FunctionPrototype {
  /**
  ...
  public EList<FunctionParameter> getParameters() {
    if (parameters == null) {
      parameters = new EObjectContainmentEList<FunctionParameter>(FunctionParameter.class, this, PiMMPackage.FUNCTION_PROTOTYPE__PARAMETERS);
    }
    return parameters;
  }
