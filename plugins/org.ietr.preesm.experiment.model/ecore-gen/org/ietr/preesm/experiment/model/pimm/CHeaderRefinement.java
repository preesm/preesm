...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>CHeader Refinement</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
...
public interface CHeaderRefinement extends Refinement {
  /**
   * Returns the value of the '<em><b>Loop Prototype</b></em>' containment reference.
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Loop Prototype</em>' containment reference isn't clear,
   ...
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @param value the new value of the '<em>Loop Prototype</em>' containment reference.
  ...
  /**
   * Returns the value of the '<em><b>Init Prototype</b></em>' containment reference.
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Init Prototype</em>' containment reference isn't clear,
   * there really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   ...
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @param value the new value of the '<em>Init Prototype</em>' containment reference.
