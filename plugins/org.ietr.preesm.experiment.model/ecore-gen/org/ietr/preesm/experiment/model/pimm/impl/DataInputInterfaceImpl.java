...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Data Input Interface</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class DataInputInterfaceImpl extends AbstractActorImpl implements DataInputInterface {
    ...
    if (graphPort != null && graphPort.eIsProxy()) {
      ...
      if (graphPort != oldGraphPort) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, PiMMPackage.DATA_INPUT_INTERFACE__GRAPH_PORT, oldGraphPort, graphPort));
      }
    }
    return graphPort;
  }
  ...
  public void setGraphPort(Port newGraphPort) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PiMMPackage.DATA_INPUT_INTERFACE__GRAPH_PORT, oldGraphPort, graphPort));
  }
