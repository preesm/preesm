...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Data Output Interface</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class DataOutputInterfaceImpl extends AbstractActorImpl implements DataOutputInterface {
    ...
    if (graphPort != null && graphPort.eIsProxy()) {
      ...
      if (graphPort != oldGraphPort) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, PiMMPackage.DATA_OUTPUT_INTERFACE__GRAPH_PORT, oldGraphPort, graphPort));
      }
    }
    return graphPort;
  }
  ...
  public void setGraphPort(Port newGraphPort) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PiMMPackage.DATA_OUTPUT_INTERFACE__GRAPH_PORT, oldGraphPort, graphPort));
  }
