...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Data Output Interface</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link org.ietr.preesm.experiment.model.pimm.impl.DataOutputInterfaceImpl#getGraphPort <em>Graph Port</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DataOutputInterfaceImpl extends AbstractActorImpl implements DataOutputInterface {
  /**
    ...
    if ((this.graphPort != null) && this.graphPort.eIsProxy()) {
      ...
      if (this.graphPort != oldGraphPort) {
        if (eNotificationRequired()) {
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, PiMMPackage.DATA_OUTPUT_INTERFACE__GRAPH_PORT, oldGraphPort, this.graphPort));
        }
      }
    }
  ...
  public void setGraphPort(final Port newGraphPort) {
    ...
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET, PiMMPackage.DATA_OUTPUT_INTERFACE__GRAPH_PORT, oldGraphPort, this.graphPort));
    }
  }
  ...
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
      case PiMMPackage.DATA_OUTPUT_INTERFACE__GRAPH_PORT:
        if (resolve) {
          return getGraphPort();
        }
