 ...
 * <ul>
 *   <li>{@link org.ietr.preesm.experiment.model.pimemoc.impl.OutputPortImpl#getOutgoingFifo <em>Outgoing Fifo</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OutputPortImpl extends PortImpl implements OutputPort {
		...
		if (outgoingFifo != null && outgoingFifo.eIsProxy()) {
			...
			if (outgoingFifo != oldOutgoingFifo) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, PIMeMoCPackage.OUTPUT_PORT__OUTGOING_FIFO, oldOutgoingFifo, outgoingFifo));
			}
		}
		return outgoingFifo;
	}
	...
	public NotificationChain basicSetOutgoingFifo(Fifo newOutgoingFifo, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PIMeMoCPackage.OUTPUT_PORT__OUTGOING_FIFO, oldOutgoingFifo, newOutgoingFifo);
	...
	public void setOutgoingFifo(Fifo newOutgoingFifo) {
		if (newOutgoingFifo != outgoingFifo) {
			...
			if (outgoingFifo != null)
				msgs = ((InternalEObject)outgoingFifo).eInverseRemove(this, PIMeMoCPackage.FIFO__SOURCE_PORT, Fifo.class, msgs);
			if (newOutgoingFifo != null)
				msgs = ((InternalEObject)newOutgoingFifo).eInverseAdd(this, PIMeMoCPackage.FIFO__SOURCE_PORT, Fifo.class, msgs);
			msgs = basicSetOutgoingFifo(newOutgoingFifo, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PIMeMoCPackage.OUTPUT_PORT__OUTGOING_FIFO, newOutgoingFifo, newOutgoingFifo));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case PIMeMoCPackage.OUTPUT_PORT__OUTGOING_FIFO:
				if (outgoingFifo != null)
					msgs = ((InternalEObject)outgoingFifo).eInverseRemove(this, PIMeMoCPackage.FIFO__SOURCE_PORT, Fifo.class, msgs);
