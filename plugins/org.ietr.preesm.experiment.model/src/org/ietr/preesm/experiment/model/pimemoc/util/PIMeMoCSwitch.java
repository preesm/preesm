 ...
 * @generated
 */
public class PIMeMoCSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case PIMeMoCPackage.PORT: {
				Port port = (Port)theEObject;
				T result = casePort(port);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PIMeMoCPackage.INPUT_PORT: {
			...
			case PIMeMoCPackage.OUTPUT_PORT: {
			...
			case PIMeMoCPackage.INTERFACE_VERTEX: {
			...
			case PIMeMoCPackage.SINK_INTERFACE: {
