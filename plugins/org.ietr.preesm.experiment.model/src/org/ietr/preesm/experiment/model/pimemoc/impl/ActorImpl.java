 ...
 * <ul>
 * <li>
 * {@link org.ietr.preesm.experiment.model.pimemoc.impl.ActorImpl#getRefinement
 * <em>Refinement</em>}</li>
 * </ul>
 * </p>
 * 
	...
	public NotificationChain basicSetRefinement(Refinement newRefinement,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, PIMeMoCPackage.ACTOR__REFINEMENT,
	...
	public void setRefinement(Refinement newRefinement) {
		if (newRefinement != refinement) {
			...
			if (refinement != null)
				msgs = ((InternalEObject) refinement).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE
								- PIMeMoCPackage.ACTOR__REFINEMENT, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					PIMeMoCPackage.ACTOR__REFINEMENT, newRefinement,
					newRefinement));
	}
