 ...
 * <ul>
 * <li>
 * {@link org.ietr.preesm.experiment.model.pimemoc.impl.InterfaceVertexImpl#getGraphPort
 * <em>Graph Port</em>}</li>
 * <li>
 * {@link org.ietr.preesm.experiment.model.pimemoc.impl.InterfaceVertexImpl#getKind
 * <em>Kind</em>}</li>
 * </ul>
 * </p>
 * 
...
public class InterfaceVertexImpl extends AbstractVertexImpl implements
	 ...
	 * reference. <!-- begin-user-doc --> This {@link Port} is the corresponding
			...
			if (graphPort != oldGraphPort) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							PIMeMoCPackage.INTERFACE_VERTEX__GRAPH_PORT,
							oldGraphPort, graphPort));
			}
		}
		return graphPort;
	}
	...
	public void setGraphPort(Port newGraphPort) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					PIMeMoCPackage.INTERFACE_VERTEX__GRAPH_PORT, oldGraphPort,
					graphPort));
	}
