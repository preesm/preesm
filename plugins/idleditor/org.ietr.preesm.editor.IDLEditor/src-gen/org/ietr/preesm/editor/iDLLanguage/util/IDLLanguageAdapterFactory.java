 ...
 */
package org.ietr.preesm.editor.iDLLanguage.util;
 ...
 * @generated
 */
public class IDLLanguageAdapterFactory extends AdapterFactoryImpl
{
  /**
   ...
   * @generated
   */
  protected static IDLLanguagePackage modelPackage;
   ...
   * @generated
   */
  public IDLLanguageAdapterFactory()
  {
    if (modelPackage == null)
    {
      modelPackage = IDLLanguagePackage.eINSTANCE;
    }
  }
   ...
   * @generated
   */
  protected IDLLanguageSwitch<Adapter> modelSwitch =
    new IDLLanguageSwitch<Adapter>()
    {
      @Override
      public Adapter caseIDL(IDL object)
      {
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.ietr.preesm.editor.iDLLanguage.IDL <em>IDL</em>}'.
   * <!-- begin-user-doc -->
   ...
   * @generated
   */
  public Adapter createIDLAdapter()
  {
    return null;
  }
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.ietr.preesm.editor.iDLLanguage.DataType <em>Data Type</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
