 ...
 * @generated
 */
public class IDLLanguageSwitch<T> extends Switch<T>
{
  /**
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      case IDLLanguagePackage.IDL:
      {
        IDL idl = (IDL)theEObject;
        T result = caseIDL(idl);
      ...
      case IDLLanguagePackage.DATA_TYPE:
      {
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>IDL</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>IDL</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseIDL(IDL object)
  {
    return null;
  }
