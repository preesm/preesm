...
public class IDLLanguageParser extends org.eclipse.xtext.parser.antlr.AbstractAntlrParser {
	...
	protected IParseResult parse(String ruleName, CharStream in) {
		...
		org.ietr.preesm.editor.parser.antlr.internal.InternalIDLLanguageParser parser = createParser(tokenStream);
	...
	protected org.ietr.preesm.editor.parser.antlr.internal.InternalIDLLanguageParser createParser(XtextTokenStream stream) {
		return new org.ietr.preesm.editor.parser.antlr.internal.InternalIDLLanguageParser(stream, getElementFactory(), getGrammarAccess());
	}
