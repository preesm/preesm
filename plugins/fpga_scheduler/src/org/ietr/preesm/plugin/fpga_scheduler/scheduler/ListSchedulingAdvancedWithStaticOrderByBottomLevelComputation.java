...
public class ListSchedulingAdvancedWithStaticOrderByBottomLevelComputation
		extends ListSchedulingAdvanced {

	public ListSchedulingAdvancedWithStaticOrderByBottomLevelComputation(
			AlgorithmDescriptor algorithm, ArchitectureDescriptor architecture) {
		super(algorithm, architecture);
		// TODO Auto-generated constructor stub
		this.name = "List Scheduling Advanced With Static Order By Bottom Level Computation";
	}
