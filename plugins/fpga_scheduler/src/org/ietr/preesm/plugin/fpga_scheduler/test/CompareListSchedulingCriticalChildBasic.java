...
public class CompareListSchedulingCriticalChildBasic extends
		CompareListScheduling {

	public CompareListSchedulingCriticalChildBasic(String algorithmFileName,
			String parameterFileName, String architectureFileName) {
		super(algorithmFileName, parameterFileName, architectureFileName);
		System.out
				.println("\n***** Compare List Scheduling Critical Child Begins! *****");
		parse(algorithmFileName, architectureFileName, parameterFileName);
		ListSchedulingCriticalChildBasicWithStaticOrderByBottomLevelComputation scheduler1 = new ListSchedulingCriticalChildBasicWithStaticOrderByBottomLevelComputation(
				algorithm, architecture);
		testScheduler(scheduler1, algorithm, architecture);

		parse(algorithmFileName, architectureFileName, parameterFileName);
		ListSchedulingCriticalChildBasicWithStaticOrderByBottomLevel scheduler2 = new ListSchedulingCriticalChildBasicWithStaticOrderByBottomLevel(
				algorithm, architecture);
		testScheduler(scheduler2, algorithm, architecture);

		parse(algorithmFileName, architectureFileName, parameterFileName);
		ListSchedulingCriticalChildBasicWithStaticOrderByBottomLevelIn scheduler3 = new ListSchedulingCriticalChildBasicWithStaticOrderByBottomLevelIn(
				algorithm, architecture);
		testScheduler(scheduler3, algorithm, architecture);

		parse(algorithmFileName, architectureFileName, parameterFileName);
		ListSchedulingCriticalChildBasicWithStaticOrderByBottomLevelOut scheduler4 = new ListSchedulingCriticalChildBasicWithStaticOrderByBottomLevelOut(
				algorithm, architecture);
		testScheduler(scheduler4, algorithm, architecture);

		parse(algorithmFileName, architectureFileName, parameterFileName);
		ListSchedulingCriticalChildBasicWithStaticOrderByBottomLevelInOut scheduler5 = new ListSchedulingCriticalChildBasicWithStaticOrderByBottomLevelInOut(
				algorithm, architecture);
		...
		System.out
				.println("\n\n*****Compare List Scheduling Critical Child Finishes!*****");
	}
	...
	public static void main(String[] args) {
		...
		new CompareListSchedulingCriticalChildBasic(algorithmFileName,
