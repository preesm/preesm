...
public class CompareListSchedulingCriticalChild extends CompareListScheduling {

	public CompareListSchedulingCriticalChild(String algorithmFileName,
		...
		ListSchedulingCriticalChildWithStaticOrderByBottomLevelComputation scheduler1 = new ListSchedulingCriticalChildWithStaticOrderByBottomLevelComputation(
				algorithm, architecture);
		testScheduler(scheduler1, algorithm, architecture);

		parse(algorithmFileName, architectureFileName, parameterFileName);
		ListSchedulingCriticalChildWithStaticOrderByBottomLevel scheduler2 = new ListSchedulingCriticalChildWithStaticOrderByBottomLevel(
				algorithm, architecture);
		testScheduler(scheduler2, algorithm, architecture);

		parse(algorithmFileName, architectureFileName, parameterFileName);
		ListSchedulingCriticalChildWithStaticOrderByBottomLevelIn scheduler3 = new ListSchedulingCriticalChildWithStaticOrderByBottomLevelIn(
				algorithm, architecture);
		testScheduler(scheduler3, algorithm, architecture);

		parse(algorithmFileName, architectureFileName, parameterFileName);
		ListSchedulingCriticalChildWithStaticOrderByBottomLevelOut scheduler4 = new ListSchedulingCriticalChildWithStaticOrderByBottomLevelOut(
				algorithm, architecture);
		testScheduler(scheduler4, algorithm, architecture);

		parse(algorithmFileName, architectureFileName, parameterFileName);
		ListSchedulingCriticalChildWithStaticOrderByBottomLevelInOut scheduler5 = new ListSchedulingCriticalChildWithStaticOrderByBottomLevelInOut(
				algorithm, architecture);
	...
	public static void main(String[] args) {
		...
		new CompareListSchedulingCriticalChild(algorithmFileName,
