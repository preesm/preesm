...
public class ListSchedulingCommunicationDelayWithStaticOrderByBottomLevel
		extends ListSchedulingCommunicationDelay {

	public ListSchedulingCommunicationDelayWithStaticOrderByBottomLevel(
			AlgorithmDescriptor algorithm, ArchitectureDescriptor architecture) {
		super(algorithm, architecture);
		// TODO Auto-generated constructor stub
		this.name = "List Scheduling CommunicationDelay With Static Order By Bottom Level";
	}
