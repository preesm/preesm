...
public class ListSchedulingBasicWithStaticOrderByBottomLevelIn extends
		ListSchedulingBasic {

	public ListSchedulingBasicWithStaticOrderByBottomLevelIn(
			AlgorithmDescriptor algorithm, ArchitectureDescriptor architecture) {
		super(algorithm, architecture);
		// TODO Auto-generated constructor stub
		this.name = "List Scheduling Basic With Static Order By Bottom Level In";
	}
