...
public class CompareListSchedulingAdvanced extends CompareListScheduling {

	public CompareListSchedulingAdvanced(String algorithmFileName,
			String parameterFileName, String architectureFileName) {
		super(algorithmFileName, parameterFileName, architectureFileName);
		System.out
				.println("\n***** Compare List Scheduling Advanced Begins! *****");
		parse(algorithmFileName, architectureFileName, parameterFileName);
		ListSchedulingAdvancedWithStaticOrderByBottomLevelComputation scheduler1 = new ListSchedulingAdvancedWithStaticOrderByBottomLevelComputation(
				algorithm, architecture);
		testScheduler(scheduler1, algorithm, architecture);

		parse(algorithmFileName, architectureFileName, parameterFileName);
		ListSchedulingAdvancedWithStaticOrderByBottomLevel scheduler2 = new ListSchedulingAdvancedWithStaticOrderByBottomLevel(
				algorithm, architecture);
		testScheduler(scheduler2, algorithm, architecture);

		parse(algorithmFileName, architectureFileName, parameterFileName);
		ListSchedulingAdvancedWithStaticOrderByBottomLevelIn scheduler3 = new ListSchedulingAdvancedWithStaticOrderByBottomLevelIn(
				algorithm, architecture);
		testScheduler(scheduler3, algorithm, architecture);

		parse(algorithmFileName, architectureFileName, parameterFileName);
		ListSchedulingAdvancedWithStaticOrderByBottomLevelOut scheduler4 = new ListSchedulingAdvancedWithStaticOrderByBottomLevelOut(
				algorithm, architecture);
		testScheduler(scheduler4, algorithm, architecture);

		parse(algorithmFileName, architectureFileName, parameterFileName);
		ListSchedulingAdvancedWithStaticOrderByBottomLevelInOut scheduler5 = new ListSchedulingAdvancedWithStaticOrderByBottomLevelInOut(
				algorithm, architecture);
		...
		System.out
				.println("\n\n*****Compare List Scheduling Advanced Finishes!*****");
	}
	...
	public static void main(String[] args) {
		...
		new CompareListSchedulingAdvanced(algorithmFileName, parameterFileName,
