...
public class ListSchedulingCriticalChildBasicWithStaticOrderByBottomLevelInOut
		extends ListSchedulingCriticalChildBasic {

	public ListSchedulingCriticalChildBasicWithStaticOrderByBottomLevelInOut(
			AlgorithmDescriptor algorithm, ArchitectureDescriptor architecture) {
		super(algorithm, architecture);
		// TODO Auto-generated constructor stub
		this.name = "List Scheduling CriticalChildBasic With Static Order By Bottom Level InOut";
	}
