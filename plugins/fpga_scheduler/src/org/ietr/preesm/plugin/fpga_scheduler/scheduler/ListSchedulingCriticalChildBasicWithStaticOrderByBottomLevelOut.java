...
public class ListSchedulingCriticalChildBasicWithStaticOrderByBottomLevelOut
		extends ListSchedulingCriticalChildBasic {

	public ListSchedulingCriticalChildBasicWithStaticOrderByBottomLevelOut(
			AlgorithmDescriptor algorithm, ArchitectureDescriptor architecture) {
		super(algorithm, architecture);
		// TODO Auto-generated constructor stub
		this.name = "List Scheduling CriticalChildBasic With Static Order By Bottom Level Out";
	}
