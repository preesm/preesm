...
public class ListSchedulingCriticalChild extends AbstractScheduler {

	public ListSchedulingCriticalChild(AlgorithmDescriptor algorithm,
			ArchitectureDescriptor architecture) {
		super(algorithm);
		this.architecture = architecture;
		this.name = "List Scheduling Critical Child";
	}
