...
public class CompareListSchedulingBasic extends CompareListScheduling {

	public CompareListSchedulingBasic(String algorithmFileName,
			String parameterFileName, String architectureFileName) {
		super(algorithmFileName, parameterFileName, architectureFileName);
		System.out
				.println("\n***** Compare List Scheduling Basic Begins! *****");

		parse(algorithmFileName, architectureFileName, parameterFileName);
		ListSchedulingBasicWithStaticOrderByBottomLevelComputation scheduler1 = new ListSchedulingBasicWithStaticOrderByBottomLevelComputation(
				algorithm, architecture);
		testScheduler(scheduler1, algorithm, architecture);

		parse(algorithmFileName, architectureFileName, parameterFileName);
		ListSchedulingBasicWithStaticOrderByBottomLevel scheduler2 = new ListSchedulingBasicWithStaticOrderByBottomLevel(
				algorithm, architecture);
		testScheduler(scheduler2, algorithm, architecture);

		parse(algorithmFileName, architectureFileName, parameterFileName);
		ListSchedulingBasicWithStaticOrderByBottomLevelIn scheduler3 = new ListSchedulingBasicWithStaticOrderByBottomLevelIn(
				algorithm, architecture);
		testScheduler(scheduler3, algorithm, architecture);

		parse(algorithmFileName, architectureFileName, parameterFileName);
		ListSchedulingBasicWithStaticOrderByBottomLevelOut scheduler4 = new ListSchedulingBasicWithStaticOrderByBottomLevelOut(
				algorithm, architecture);
		testScheduler(scheduler4, algorithm, architecture);

		parse(algorithmFileName, architectureFileName, parameterFileName);
		ListSchedulingBasicWithStaticOrderByBottomLevelInOut scheduler5 = new ListSchedulingBasicWithStaticOrderByBottomLevelInOut(
				algorithm, architecture);
		...
		System.out
				.println("\n\n*****Compare List Scheduling Basic Finishes!*****");
	}
	...
	public static void main(String[] args) {
		...
		new CompareListSchedulingBasic(algorithmFileName, parameterFileName,
