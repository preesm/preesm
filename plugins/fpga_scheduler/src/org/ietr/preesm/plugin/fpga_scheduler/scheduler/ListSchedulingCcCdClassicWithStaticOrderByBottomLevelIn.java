...
public class ListSchedulingCcCdClassicWithStaticOrderByBottomLevelIn extends
		ListSchedulingCcCdClassic {

	public ListSchedulingCcCdClassicWithStaticOrderByBottomLevelIn(
			AlgorithmDescriptor algorithm, ArchitectureDescriptor architecture) {
		super(algorithm, architecture);
		// TODO Auto-generated constructor stub
		this.name = "List Scheduling CcCdClassic With Static Order By Bottom Level In";
	}
