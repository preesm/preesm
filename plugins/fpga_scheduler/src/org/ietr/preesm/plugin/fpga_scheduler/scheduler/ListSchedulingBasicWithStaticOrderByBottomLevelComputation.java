...
public class ListSchedulingBasicWithStaticOrderByBottomLevelComputation
		extends ListSchedulingBasic {

	public ListSchedulingBasicWithStaticOrderByBottomLevelComputation(
			AlgorithmDescriptor algorithm, ArchitectureDescriptor architecture) {
		super(algorithm, architecture);
		// TODO Auto-generated constructor stub
		this.name = "List Scheduling Basic With Static Order By Bottom Level Computation";
	}
