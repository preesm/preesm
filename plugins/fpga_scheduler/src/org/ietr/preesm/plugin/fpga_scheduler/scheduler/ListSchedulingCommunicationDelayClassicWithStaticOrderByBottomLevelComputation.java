...
public class ListSchedulingCommunicationDelayClassicWithStaticOrderByBottomLevelComputation
		extends ListSchedulingCommunicationDelayClassic {

	public ListSchedulingCommunicationDelayClassicWithStaticOrderByBottomLevelComputation(
			AlgorithmDescriptor algorithm, ArchitectureDescriptor architecture) {
		super(algorithm, architecture);
		// TODO Auto-generated constructor stub
		this.name = "List Scheduling CommunicationDelayClassic With Static Order By Bottom Level Computation";
	}
