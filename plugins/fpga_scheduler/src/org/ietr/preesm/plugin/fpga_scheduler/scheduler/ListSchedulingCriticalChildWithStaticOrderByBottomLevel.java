...
public class ListSchedulingCriticalChildWithStaticOrderByBottomLevel extends
		ListSchedulingCriticalChild {

	public ListSchedulingCriticalChildWithStaticOrderByBottomLevel(
			AlgorithmDescriptor algorithm, ArchitectureDescriptor architecture) {
		super(algorithm, architecture);
		// TODO Auto-generated constructor stub
		this.name = "List Scheduling CriticalChild With Static Order By Bottom Level";
	}
