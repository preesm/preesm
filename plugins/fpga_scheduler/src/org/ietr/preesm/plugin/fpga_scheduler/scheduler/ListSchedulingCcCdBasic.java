...
public class ListSchedulingCcCdBasic extends AbstractScheduler {

	public ListSchedulingCcCdBasic(AlgorithmDescriptor algorithm,
			ArchitectureDescriptor architecture) {
		super(algorithm);
		this.architecture = architecture;
		this.name = "List Scheduling CcCdBasic";
	}
