...
public class ListSchedulingClassicWithStaticOrderByBottomLevelIn extends
		ListSchedulingClassic {

	public ListSchedulingClassicWithStaticOrderByBottomLevelIn(
			AlgorithmDescriptor algorithm, ArchitectureDescriptor architecture) {
		super(algorithm, architecture);
		// TODO Auto-generated constructor stub
		this.name = "List Scheduling Classic With Static Order By Bottom Level In";
	}
