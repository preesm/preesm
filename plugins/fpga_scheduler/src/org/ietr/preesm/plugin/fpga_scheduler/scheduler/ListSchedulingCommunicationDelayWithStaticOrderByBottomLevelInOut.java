...
public class ListSchedulingCommunicationDelayWithStaticOrderByBottomLevelInOut
		extends ListSchedulingCommunicationDelay {

	public ListSchedulingCommunicationDelayWithStaticOrderByBottomLevelInOut(
			AlgorithmDescriptor algorithm, ArchitectureDescriptor architecture) {
		super(algorithm, architecture);
		// TODO Auto-generated constructor stub
		this.name = "List Scheduling CommunicationDelay With Static Order By Bottom Level InOut";
	}
