...
/**
 * Class used to handle the {@link GraphicsAlgorithm} of a {@link House}
 * {@link Polygon}.
 * 
 * @author kdesnos
 * 
...
public class House extends PolygonImpl {

	/**
	 * Default points
	 */
	protected static int xy[] = new int[] { 12, 0, 24, 26, 24, 40, 0, 40, 0, 26 };

	public House(ContainerShape containerShape) {
		super();
	...
	protected void setSize(int width, int height) {
		int coord[] = new int[] { width / 2, 0, width, height - 14, width,
				height, 0, height, 0, height - 14 };
