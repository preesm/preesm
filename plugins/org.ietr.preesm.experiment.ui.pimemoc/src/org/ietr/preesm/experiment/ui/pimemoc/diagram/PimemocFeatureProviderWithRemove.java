 ...
 * PimemocFeatureProvider because we do not want it to appear in the Graphical
 * Interface. Indeed, the "remove" operation simply remove the pictogram from
 * the GUI, but does not remove the corresponding Object from the Business
 * Model. We feel that it might lead to incoherences.
 * 
 ...
 * 
 */
public class PimemocFeatureProviderWithRemove extends PimemocFeatureProvider {
	/**
	 * Default constructor
	 * 
	 * @param dtp
