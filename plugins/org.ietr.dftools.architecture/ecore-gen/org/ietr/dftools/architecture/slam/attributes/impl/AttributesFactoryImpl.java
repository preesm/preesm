...
public class AttributesFactoryImpl extends EFactoryImpl implements AttributesFactory {
	...
	public static AttributesFactory init() {
		try {
			AttributesFactory theAttributesFactory = (AttributesFactory)EPackage.Registry.INSTANCE.getEFactory(AttributesPackage.eNS_URI);
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			case AttributesPackage.IPATH:
				return createIPathFromString(eDataType, initialValue);
			case AttributesPackage.STRING:
				return createStringFromString(eDataType, initialValue);
			case AttributesPackage.INT:
				return createintFromString(eDataType, initialValue);
			case AttributesPackage.LONG:
				return createlongFromString(eDataType, initialValue);
			case AttributesPackage.DOUBLE:
