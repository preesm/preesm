...
\begin{document}
	...
	\tabParam{\textit{Verbose} & \multicolumn{2}{p{13.00cm}|}{How verbose will this task be during its execution. In verbose mode, the task will log the start and completion time of the build, as well as characteristics (number of memory objects, number of exclusions) of the produced \gls{meg}.} \\
		\tabValue{
