...
\begin{document}
	...
	\subsection{MEG Update with Scheduling Information}
		\tabBrief{MEG Updater}{DAG, MEG}{MEG}{Relax memory allocation constraints of the \gls{meg} using scheduling information. constraints.}{org.ietr.preesm.memory.exclusiongraph.MemExUpdater}
