...
\begin{document}
	...
	\tabBrief{MEG Builder}{DAG, scenario}{MEG}{Builds the \gls{meg} modeling the memory allocation constraints.}{org.ietr.preesm.memory.exclusiongraph.MemoryExclusion\-GraphBuilder}
	...
	\subsection{MEG Update with Scheduling Information}
		\tabBrief{MEG Updater}{DAG, MEG}{MEG}{Relax memory allocation constraints of the \gls{meg} using scheduling information.}{org.ietr.preesm.memory.exclusiongraph.MemExUpdater}
	...
	\tabBrief{Memory Bounds Estimator}{MEG}{}{Compute bounds of the amount of memory needed to allocate the \gls{meg}}{org.ietr.preesm.memory.bounds.MemoryBoundsEstimator}
