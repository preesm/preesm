...
\newcommand{\tab}[8]{
	{\centering
		\begin{longtable}[t]{|C{2.5cm}|C{2.5cm}|@{}p{10cm}@{}|}
			\hline
			\multicolumn{2}{|c|}{\textbf{Graphic Element}} & \multicolumn{1}{l|}{\textbf{Brief Description}} \\
			\hline
			\multicolumn{2}{|c|}{\task{#1}{#2}{#3}} & \begin{tabular}[t]{p{10.03cm}}
				#4 \\[1em] \hline
			...
			#8 \\
			\hline
			\multicolumn{1}{C{2.5cm}}{} & \multicolumn{1}{C{2.5cm}}{}  & \multicolumn{1}{@{}p{10cm}@{}}{} \\
		\end{longtable} 
	}
}
...
\begin{document}
	...
	\subsection{Static PiMM to IBSDF}
		\tab{StaticPiMM2SDF}{PiMM,scenario}{SDF}
...
%	\centering{
%		\begin{tabular}[t]{|C{2.5cm}|C{2.5cm}|L{10cm}|}
%			\hline
%				\multicolumn{2}{|c|}{\textbf{Graphic Element}} & \textbf{Brief Description} \\
%			\hline
%				\multicolumn{2}{|c|}{\multirow{2}{*}{\task{StaticPiMM2SDF}{PiMM,scenario}{SDF}}} & Transforms a static PiSDF Graph into an equivalent IBSDF graph.  \\[1em]
%			\cline{3 - 3}
%				\multicolumn{2}{|c|}{} &\textbf{Plugin identifier}\\
%			\cline{3 - 3}
%				\multicolumn{2}{|c|}{} &\texttt{org.ietr.preesm.experiment.pimm2sdf.StaticPiMM2SDFTask}\\[1em]
%			\hline
%				\multicolumn{3}{c}{} \\
%			\hline
