...
<dftools:workflow xmlns:dftools="http://net.sf.dftools">
    ...
    <dftools:task
        ...
        <dftools:data key="variables">
            ...
            <dftools:variable name="Nb of Shuffling Tested" value="250"/>
            <dftools:variable name="Verbose" value="True"/>
        </dftools:data>
    </dftools:task>
    <dftools:task
        ...
        <dftools:data key="variables">
            <dftools:variable name="Printer" value="C6678"/>
        </dftools:data>
    </dftools:task>
    <dftools:task
    ...
    <dftools:task
        pluginId="org.ietr.preesm.memory.bounds.MemoryBoundsEstimator" taskId="Mem Bounds 2">
        <dftools:data key="variables">
            <dftools:variable name="Solver" value="Heuristic"/>
            <dftools:variable name="Verbose" value="False"/>
        </dftools:data>
    ...
    <dftools:dataTransfer from="MemEx Updater" sourceport="MemEx"
        targetport="MemEx" to="Mem Bounds 2"/>
</dftools:workflow>
