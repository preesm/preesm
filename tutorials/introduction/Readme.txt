...
- The architecture model of a PC with 2 cores interconnected by a shared memory
- The associated code, IDL with function prototypes and CMakeLists to execute the code
