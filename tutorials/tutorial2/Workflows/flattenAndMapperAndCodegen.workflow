...
<preesm:workflow xmlns:preesm="http://ietr-image.insa-rennes.fr/projects/Preesm">
    ...
    <preesm:task pluginId="org.ietr.preesm.plugin.codegen" taskId="codegen">
        <data key="variables">
            <variable name="sourcePath" value="/tutorial2/Code/CodeGenerate"/>
            <variable name="xslLibraryPath" value="/tutorial2/Code/XSL"/>
        </data>
    </preesm:task>
    ...
    <preesm:task pluginId="org.ietr.preesm.plugin.exportXml.sdf4jgml" taskId="Exporter">
        <data key="variables">
            <variable name="path" value="/tutorial2/DAG/flatten.graphml"/>
        </data>
    </preesm:task>
    <preesm:task
