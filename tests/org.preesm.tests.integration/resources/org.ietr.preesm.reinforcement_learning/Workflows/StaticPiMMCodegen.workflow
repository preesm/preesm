...
<dftools:workflow errorOnWarning="false" verboseLevel="INFO" xmlns:dftools="http://net.sf.dftools">
    ...
    <dftools:dataTransfer from="SchedulingFromDAG"
    ...
    <dftools:dataTransfer from="scenario"
        sourceport="architecture" targetport="architecture" to="SDF2DAG"/>
    <dftools:dataTransfer from="scenario"
        sourceport="architecture" targetport="architecture" to="SchedulingFromDAG"/>
    <dftools:dataTransfer from="SchedulingFromDAG"
