...
<dftools:workflow xmlns:dftools="http://net.sf.dftools">
    ...
    <dftools:task
        pluginId="org.ietr.preesm.experiment.memory.MultiMemoryBoundsEstimator" taskId="MultiMemBounds">
        <dftools:data key="variables">
    ...
    <dftools:dataTransfer from="MultiMemExUpdate"
        sourceport="DAGsAndMemExs" targetport="DAGsAndMemExs" to="MultiMemBounds"/>
</dftools:workflow>
