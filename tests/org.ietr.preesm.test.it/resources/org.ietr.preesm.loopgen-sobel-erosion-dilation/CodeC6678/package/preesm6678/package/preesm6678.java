...
public class preesm6678
{
    ...
    void $$INITIALIZATION()
    {
        ...
        vo = (Value.Obj)om.findStrict("preesm6678.Platform", "preesm6678");
        Global.put(vo, "CPU", Global.callFxn("create", (Scriptable)om.find("ti.platforms.generic.Platform"), "CPU", Global.newObject("clockRate", 1000L, "catalogName", "ti.catalog.c6000", "deviceName", "TMS320C6678", "customMemoryMap", Global.newArray(new Object[]{Global.newArray(new Object[]{"MSMCSRAM", Global.newObject("name", "MSMCSRAM", "base", 0x0c000000L, "len", 0x00200000L, "space", "code/data", "access", "RWX")}), Global.newArray(new Object[]{"L2SRAM", Global.newObject("name", "L2SRAM", "base", 0x00800000L, "len", 0x00080000L, "space", "code/data", "access", "RWX")}), Global.newArray(new Object[]{"DDR3", Global.newObject("name", "DDR3", "base", 0x80000000L, "len", 0x20000000L, "space", "code/data", "access", "RWX")}), Global.newArray(new Object[]{"L2SRAM0", Global.newObject("name", "L2SRAM0", "base", 0x10818000L, "len", 0x00068000L, "space", "code/data", "access", "RWX")}), Global.newArray(new Object[]{"L2SRAM1", Global.newObject("name", "L2SRAM1", "base", 0x11818000L, "len", 0x00068000L, "space", "code/data", "access", "RWX")}), Global.newArray(new Object[]{"L2SRAM2", Global.newObject("name", "L2SRAM2", "base", 0x12818000L, "len", 0x00068000L, "space", "code/data", "access", "RWX")}), Global.newArray(new Object[]{"L2SRAM3", Global.newObject("name", "L2SRAM3", "base", 0x13818000L, "len", 0x00068000L, "space", "code/data", "access", "RWX")}), Global.newArray(new Object[]{"L2SRAM4", Global.newObject("name", "L2SRAM4", "base", 0x14818000L, "len", 0x00068000L, "space", "code/data", "access", "RWX")}), Global.newArray(new Object[]{"L2SRAM5", Global.newObject("name", "L2SRAM5", "base", 0x15818000L, "len", 0x00068000L, "space", "code/data", "access", "RWX")}), Global.newArray(new Object[]{"L2SRAM6", Global.newObject("name", "L2SRAM6", "base", 0x16818000L, "len", 0x00068000L, "space", "code/data", "access", "RWX")}), Global.newArray(new Object[]{"L2SRAM7", Global.newObject("name", "L2SRAM7", "base", 0x17818000L, "len", 0x00068000L, "space", "code/data", "access", "RWX")})}), "l2Mode", "0k", "l1PMode", "32k", "l1DMode", "32k")));
