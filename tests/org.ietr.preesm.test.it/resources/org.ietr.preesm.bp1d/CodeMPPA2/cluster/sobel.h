...
void producer(int width, int height, unsigned char *y, unsigned char *u, unsigned char *v);

void consummer(int id, int width, int height, unsigned char *y, unsigned char *u, unsigned char *v);
