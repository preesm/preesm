...
<preesm:workflow xmlns:preesm="http://ietr-image.insa-rennes.fr/projects/Preesm">
    ...
    <preesm:task pluginId="org.ietr.preesm.plugin.codegen" taskId="codegen">
        <data key="variables">
            <variable name="sourcePath" value="/Decodeur_Type_I_LOW_LV/Code"/>
            <variable name="xslLibraryPath" value="/Decodeur_Type_I_LOW_LV/Code/XSL"/>
        </data>
    </preesm:task>
    ...
    <preesm:task
        ...
        <data key="variables">
            <variable name="path" value="/Decodeur_Type_I_LOW_LV/DAG/outDAG.xml"/>
        </data>
    </preesm:task>
