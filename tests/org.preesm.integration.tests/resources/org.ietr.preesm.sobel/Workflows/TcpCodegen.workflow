...
<dftools:workflow xmlns:dftools="http://net.sf.dftools" errorOnWarning="true" verboseLevel="INFO">
    ...
    <dftools:dataTransfer from="scenario" sourceport="PiMM" targetport="PiMM" to="PiMM to SRDAG"/>
    <dftools:dataTransfer from="PiMM to SRDAG" sourceport="PiMM" targetport="PiMM" to="Scheduling"/>
</dftools:workflow>
