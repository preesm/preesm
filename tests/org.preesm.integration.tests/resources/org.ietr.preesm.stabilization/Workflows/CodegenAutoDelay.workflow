...
<dftools:workflow errorOnWarning="true" verboseLevel="INFO" xmlns:dftools="http://net.sf.dftools">
    ...
    <dftools:task pluginId="pisdf-delays.setter" taskId="Autodelay">
        <dftools:data key="variables">
            <dftools:variable name="Fill cycles ?" value="false"/>
            <dftools:variable name="Maximum cuts" value="1"/>
            <dftools:variable name="Selection cuts" value="4"/>
            <dftools:variable name="Test best choco ?" value="false"/>
            <dftools:variable name="Test scheduling ?" value="true"/>
        </dftools:data>
    </dftools:task>
    <dftools:task
        pluginId="org.ietr.preesm.pimm.algorithm.pimm2flat.StaticPiMM2FlatPiMMTask" taskId="PiSDF Flattener">
        <dftools:data key="variables">
    ...
    <dftools:dataTransfer from="scenario" sourceport="PiMM"
        targetport="PiMM" to="PiSDF Flattener"/>
    <dftools:dataTransfer from="PiSDF Flattener"
        sourceport="PiMM" targetport="PiMM" to="Autodelay"/>
</dftools:workflow>
