...
<dftools:workflow xmlns:dftools="http://net.sf.dftools" errorOnWarning="true" verboseLevel="INFO">
    ...
    <dftools:task pluginId="pisdf-mapper.pfast" taskId="Scheduling">
        <dftools:data key="variables">
            ...
            <dftools:variable name="procNumber" value="3"/>
    ...
    <dftools:dataTransfer from="scenario" sourceport="PiMM" targetport="PiMM" to="pisdf-srdag"/>
    ...
    <dftools:dataTransfer from="pisdf-srdag" sourceport="PiMM" targetport="PiMM" to="pisdf-export"/>
</dftools:workflow>
