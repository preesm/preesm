...
extern double *const out_1_1__in__0;  // snk_out size:= 409600*double defined in Core0
...
receiveStart();// Core0 > Core1
receiveEnd(0, 1);// Core0 > Core1
Cluster_sub0_srv_0(2048/*cfg_0*/,3/*cfg_1*/,out_0_0_2_3__MAD_Computation_raw_data_real_i__0,out_0_0_2_3__MAD_Computation_raw_data_im_i__0,MAD_Computation_mad_R_o__in_0__0,MAD_Computation_mad_I_o__in_0__0);// srv_0_0

sendStart(1, 2);// Core1 > Core2
sendEnd();// Core1 > Core2
receiveStart();// Core0 > Core1
receiveEnd(0, 1);// Core0 > Core1
Cluster_sub0_srv_0(2048/*cfg_0*/,3/*cfg_1*/,out_0_2_2_3__MAD_Computation_raw_data_real_i__0,out_0_2_2_3__MAD_Computation_raw_data_im_i__0,MAD_Computation_mad_R_o__in_2__0,MAD_Computation_mad_I_o__in_2__0);// srv_0_2
