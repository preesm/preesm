 ...
 * @date Sat Feb 15 10:52:05 CET 2025
 *
...
double *const MAD_Computation_mad_I_o__in__0 = (double*) (Shared + 0); // implode_snk_out_9_0_in_MAD_Computation_mad_I_o > snk_out_9_0_in size:= 178176*double
double *const MAD_Computation_mad_R_o__in__0 = (double*) (Shared + 1425408); // implode_snk_out_8_0_in_MAD_Computation_mad_R_o > snk_out_8_0_in size:= 178176*double
...
void* computationThread_Core0(void *arg) {
  ...
  while (!preesmStopThreads) {
    ...
    sendStart(PE_0, PE_1); // Core0 > Core1
    sendEnd(); // Core0 > Core1
    ...
    sendStart(PE_0, PE_2); // Core0 > Core2
    sendEnd(); // Core0 > Core2
    sendStart(PE_0, PE_2); // Core0 > Core2
    sendEnd(); // Core0 > Core2
    sendStart(PE_0, PE_2); // Core0 > Core2
    ...
    receiveEnd(PE_1, PE_0); // Core1 > Core0
