...
<dftools:workflow xmlns:dftools="http://net.sf.dftools" errorOnWarning="false" verboseLevel="INFO">
    ...
    <dftools:task pluginId="org.ietr.preesm.plugin.mapper.listschedulingfromdag" taskId="SchedulingFromDAG">
        <dftools:data key="variables">
    ...
    <dftools:task pluginId="org.ietr.preesm.mapper.SDF2DAGTransformation" taskId="SDF2DAG">
        <dftools:data key="variables">
            <dftools:variable name="Check" value="True"/>
            <dftools:variable name="balanceLoads" value="true"/>
            <dftools:variable name="edgeSchedType" value="Simple"/>
    ...
    <dftools:dataTransfer from="SchedulingFromDAG" sourceport="ABC" targetport="ABC" to="Display Gantt"/>
    <dftools:dataTransfer from="SchedulingFromDAG" sourceport="DAG" targetport="DAG" to="Code Generation"/>
    <dftools:dataTransfer from="SDF2DAG" sourceport="DAG" targetport="DAG" to="SchedulingFromDAG"/>
    <dftools:dataTransfer from="Single-rate Transformation" sourceport="SDF" targetport="SDF" to="SDF2DAG"/>
    <dftools:dataTransfer from="scenario" sourceport="scenario" targetport="scenario" to="SDF2DAG"/>
    <dftools:dataTransfer from="scenario" sourceport="scenario" targetport="scenario" to="SchedulingFromDAG"/>
    <dftools:dataTransfer from="scenario" sourceport="architecture" targetport="architecture" to="SDF2DAG"/>
    <dftools:dataTransfer from="scenario" sourceport="architecture" targetport="architecture" to="SchedulingFromDAG"/>
    <dftools:dataTransfer from="SchedulingFromDAG" sourceport="DAG" targetport="DAG" to="MEG Builder"/>
</dftools:workflow>
