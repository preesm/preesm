...
<dftools:workflow errorOnWarning="false" verboseLevel="INFO" xmlns:dftools="http://net.sf.dftools">
    ...
    <dftools:task
        pluginId="fi.abo.preesm.dataparallel.DataParallel" taskId="Data-Parallel Check">
        <dftools:data key="variables"/>
    </dftools:task>
    <dftools:task
        pluginId="org.ietr.preesm.plugin.exportXml.sdf4jgml" taskId="CySDF Exporter">
        <dftools:data key="variables">
    ...
    <dftools:dataTransfer from="HierarchyFlattening"
        sourceport="SDF" targetport="SDF" to="Data-Parallel Check"/>
    <dftools:dataTransfer from="Data-Parallel Check"
        sourceport="CySDF" targetport="SDF" to="CySDF Exporter"/>
</dftools:workflow>
