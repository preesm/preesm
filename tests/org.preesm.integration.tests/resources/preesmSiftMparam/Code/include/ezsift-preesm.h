...
void to_grey_float(int parallelismLevel, int image_width, int image_height,
	      IN unsigned char * uchar_rgb_img, OUT float * float_img);
...
void BarrierTranspose2x_1(int image_width, int image_height,
			  int parallelismLevel, int tot_image_size,
			  IN float * img_in, OUT float * img_out);
...
void BarrierTranspose2x_2(int image_width, int image_height,
			  int parallelismLevel, int tot_image_size,
			  IN float * img_in, OUT float * img_out);
...
void draw_keypoints_to_rgb(int nKeypointsMax, int tot_image_size,
			   int image_width, int image_height,				
			   IN struct SiftKeypoint * keypoints,
			   IN int * nbKeypoints,
			   IN unsigned char * image,
			   OUT unsigned char * rgb);
...
void initWebcam(int image_height, int image_width);

void read_yuv_frame(OUT unsigned char * img);

void v4lconvert_yuyv_to_rgb24(int parallelismLevel,
			      int image_width, int image_height,
			      IN unsigned char *src, 
			      OUT unsigned char *dest);

void displayRGB(IN unsigned char *rgb);  

void displayRGBInit(int image_height, int image_width);

void Bitmap2Yuv420p_calc2(IN unsigned char *rgb, int image_height, int image_width);
void initRGBtoYUV();
