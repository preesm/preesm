...
<dftools:workflow errorOnWarning="false" verboseLevel="INFO" xmlns:dftools="http://net.sf.dftools">
    ...
    <dftools:task pluginId="pisdf-mparams.setter" taskId="Mparams selection">
        <dftools:data key="variables">
            ...
            <dftools:variable name="3. Params objectives" value=">+Hvideo/image_height>+SIFT/imgDouble>+Hvideo/AspectRatioDenominator>-Hvideo/parallelismLevel>-Hvideo/NumeratorFrequency>+Hvideo/nKeypointsMaxUser"/>
    ...
    <dftools:dataTransfer from="Mparams selection"
        sourceport="PiMM" targetport="PiMM" to="pisdf-srdag"/>
    <dftools:dataTransfer from="scenario" sourceport="scenario"
        targetport="scenario" to="Mparams selection"/>
    <dftools:dataTransfer from="scenario"
        sourceport="architecture" targetport="architecture" to="Mparams selection"/>
    <dftools:dataTransfer from="scenario" sourceport="PiMM"
        targetport="PiMM" to="Mparams selection"/>
    <dftools:dataTransfer from="Mparams selection"
        sourceport="PiMM" targetport="PiMM" to="Param Export"/>
    <dftools:dataTransfer from="Scheduling" sourceport="ABC"
