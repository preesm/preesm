...
<dftools:workflow xmlns:dftools="http://net.sf.dftools" errorOnWarning="true" verboseLevel="INFO">
    ...
    <dftools:task pluginId="pisdf-mapper.list" taskId="Sceduling FromDAG">
        <dftools:data key="variables">
    ...
    <dftools:dataTransfer from="Sceduling FromDAG" sourceport="ABC" targetport="ABC" to="Display Gantt"/>
    <dftools:dataTransfer from="Sceduling FromDAG" sourceport="ABC" targetport="ABC" to="Gantt Exporter"/>
    <dftools:dataTransfer from="Sceduling FromDAG" sourceport="DAG" targetport="DAG" to="MEG Builder"/>
    <dftools:dataTransfer from="Sceduling FromDAG" sourceport="DAG" targetport="DAG" to="Code Generation"/>
    <dftools:dataTransfer from="PiMM2SrDAG" sourceport="PiMM" targetport="PiMM" to="Sceduling FromDAG"/>
    <dftools:dataTransfer from="scenario" sourceport="PiMM" targetport="PiMM" to="PiMM2SrDAG"/>
    <dftools:dataTransfer from="scenario" sourceport="architecture" targetport="architecture" to="Sceduling FromDAG"/>
    <dftools:dataTransfer from="scenario" sourceport="scenario" targetport="scenario" to="Sceduling FromDAG"/>
