...
<dftools:workflow xmlns:dftools="http://net.sf.dftools" errorOnWarning="false" verboseLevel="INFO">
    ...
    <dftools:dataTransfer from="scenario" sourceport="scenario" targetport="scenario" to="Mapping Scheduling"/>
    ...
    <dftools:dataTransfer from="scenario" sourceport="scenario" targetport="scenario" to="Memory Allocation"/>
    <dftools:dataTransfer from="scenario" sourceport="scenario" targetport="scenario" to="Code Generation"/>
    <dftools:dataTransfer from="scenario" sourceport="scenario" targetport="scenario" to="gantt"/>
</dftools:workflow>
