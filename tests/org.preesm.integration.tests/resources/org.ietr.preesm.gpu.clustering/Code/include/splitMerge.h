...
*/
__global__ void split(int nbSlice, int width, int height, IN unsigned char *input, OUT unsigned char *output);;
...
*/
__global__ void merge(int nbSlice, int width, int height, IN unsigned char *input, OUT unsigned char *output);
