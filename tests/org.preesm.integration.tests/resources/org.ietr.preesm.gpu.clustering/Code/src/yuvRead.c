...
/*========================================================================
   ...
   ======================================================================*/
__global__ void readYUV(int width, int height, unsigned char *y, unsigned char *u, unsigned char *v) {
...
__global__ void readYUV_gpu(int width, int height, unsigned char *y, unsigned char *u, unsigned char *v) {
