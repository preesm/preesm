...
<dftools:workflow xmlns:dftools="http://net.sf.dftools">
    ...
    <dftools:task
        pluginId="org.ietr.preesm.plugin.mapper.listscheduling" taskId="FAST scheduler">
        <dftools:data key="variables">
    ...
    <dftools:dataTransfer from="srSDF" sourceport="SDF" targetport="SDF" to="FAST scheduler"/>
    <dftools:dataTransfer from="HierarchyFlattening" sourceport="SDF"
